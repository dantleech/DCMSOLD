...
class DCMSMarkdownBundle extends ModuleBundle
{
    protected function setupModule(ModuleManager $mm)
    {
        ...
        $m->createEndpointDefinition('DCMS\Bundle\MarkdownBundle\Document\MarkdownEndpoint')
            ->setTitle('Markdown')
            ->setEditController('DCMSMarkdownBundle:Endpoint:edit')
            ->setRenderController('DCMSMarkdownBundle:Endpoint:render')
            ->setRoutingResource('@DCMSMarkdownBundle/Resources/config/routing/endpoint.yml')
            ->setFormTypes(array(
